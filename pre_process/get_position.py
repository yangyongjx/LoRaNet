...
def cam_config():
    ...
    cap = cv2.VideoCapture('D:/NestData/10-5-2019-64-chirp-16bit/video_frame_37-59.mp4')
...
def cam_run():
    ...
    '''
        save stat
    '''
    # text_file = open('D:/NestData/10-5-2019-64-chirp-16bit/pos_process_new/frame_number_37-59.txt', 'w')
    # rt_text_file = open('D:/NestData/10-5-2019-64-chirp-16bit/pos_process_new/rt_matrix_37-59.txt', 'w')
    # all_frame_detect = open('D:/NestData/10-5-2019-64-chirp-16bit/pos_process_new/all_frame_37-59.txt', 'w')
    '''
    ...
    while ret == True:
        ...
        '''
            create point in real word coordinate
        '''
        ...
        if ids.any() and frame_trigger:
            ...
            #     np.save("D:/NestData/10-5-2019-64-chirp-16bit/pos_process_new/radar_pos_label_37-59",np.array(frame_radar))
            #     print('wake text')
            #     print(np.array(frame_radar).shape)

            avg_frame = collections.deque(maxlen=15)    
            frame_count = 0
            frame_limit = 0
