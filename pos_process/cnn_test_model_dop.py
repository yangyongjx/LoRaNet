...
def run_graph(radar_train_data, radar_test_data, dis_train_label, dis_test_label):
    ...
    model_load = 'C:/Users/nakorn-vision/Documents/PythonFile/NestProject/Nest_Model/model/saved_model/model_cnn_6_layers_batchnorm_complex_exp_1_cont/4plot.ckpt'

    batch_test_size = 19222
    batch_test_len = 0
    ...
    with tf.Session(config=config) as sess:
        ...
        np.save('C:/Users/nakorn-vision/Documents/PythonFile/NestProject/Nest_Model/pos_process/prediction_data/predict_data_complex_exp(train)', prediction)
...
def main():
    ...
    np.save('C:/Users/nakorn-vision/Documents/PythonFile/NestProject/Nest_Model/pos_process/test_data/dis_test_data_complex_exp(train)', dis_train_label)
